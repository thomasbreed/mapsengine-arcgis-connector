...
{
    public class ToolsCommand_AdvancedConnectionSettings : ESRI.ArcGIS.Desktop.AddIns.Button
    {
        // setup and configure log4net
        protected static readonly ILog log = LogManager.GetLogger(typeof(ToolsCommand_AdvancedConnectionSettings));

        public ToolsCommand_AdvancedConnectionSettings()
        {
            // initialize and configure log4net, reading from Xml .config file
            log4net.Config.XmlConfigurator.Configure(new System.IO.FileInfo("log4net.config"));

            log.Info("ToolsCommand_AdvancedConnectionSettings initializing.");
        }
